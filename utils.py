...
#Первая принимает список питоновских словарей, создавая JSON файл. А вторая – трансформирует JSON файл в список питоновских словарей. Далее мы просто импортируем эту функцию в приложение FastApi.
